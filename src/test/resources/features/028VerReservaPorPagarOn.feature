...
@tag1	
	Scenario: Ver reservas por pagar
		Given al navegar hasta la url "https://www.easycancha.com/book/search?lang=es-CL&country=CL"
	#	And descartar prime "/html/body/div[1]/div/div/div/div[2]/a"
		...
		And seleccionar notificaciones '//*[@id="profile-views"]/main/section[3]/ul[3]/li[1]/a/span'
		And preferencia notificacion '//*[@id="profile-views"]/main/section[1]/div/a'
		Then mover switch '//*[@id="profile-views"]/main/section[2]/ul/li/div/div/div'