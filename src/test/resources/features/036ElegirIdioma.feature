...
Feature: Perfil Usuario
	...
	#	And descartar prime "/html/body/div[1]/div/div/div/div[2]/a"
		...
		And seleccionar idioma "//*[@id='profile-views']/main/section[3]/ul[1]/li[5]/a/span"
		Then seleccionar ingles "//*[@id='profile-views']/main/section[2]/ul/li[14]/a/span"