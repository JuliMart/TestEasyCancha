...
Feature: Perfil Usuario
	...
	#	And descartar prime "/html/body/div[1]/div/div/div/div[2]/a"
		...
		And seleccionar pais "//*[@id='profile-views']/main/section[3]/ul[1]/li[4]/a/span"
		Then elegir pais para utilizar la app "//*[@id='profile-views']/main/section[2]/ul/li[1]"